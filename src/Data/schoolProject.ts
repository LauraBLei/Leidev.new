  ...
  projectData: [
    {
      ...
      images: [
        { src: "./projectImages/school/CSM1.png", alt: "Home page of CSM" },
      ],
      id: "1",
    ...
    },
    {
      ...
      images: [
        ...
        {
          src: "./projectImages/school/holidaze2.png",
          alt: "Holidaze website",
        },
        {
          src: "./projectImages/school/holidaze3.png",
          alt: "Holidaze website",
        },
        {
          src: "./projectImages/school/holidaze4.png",
          alt: "Holidaze website",
        },
      ],
      id: "4",

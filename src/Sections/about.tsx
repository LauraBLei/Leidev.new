  ...
  return (
    <div className="font-primary flex flex-col max-w-[1400px]">
      <div className="w-full p-3 bg-leiDevBlue  text-MatteBlack flex justify-between">
        ...
        <div className="absolute z-30 right-0 mt-[-50px] md:mt-[-100px] mr-1.5 rounded-full overflow-hidden w-[128px] md:w-[200px] h-[128px] md:h-[200px] flex justify-end items-end">
